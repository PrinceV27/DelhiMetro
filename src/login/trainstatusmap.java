 ...
 * @author DELL-PC
 */
public class trainstatusmap extends javax.swing.JFrame {

    /**
     * Creates new form trainstatusmap
     */
    public trainstatusmap() {
        initComponents();
    }
   ...
   dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trainstatusmap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trainstatusmap().setVisible(true);
            }
        });
    }
